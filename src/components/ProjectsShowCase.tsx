  ...
  return (
    <div className="relative">
      ...
      <div className="relative text-center">
        ...
        <Reveal replay>
          <p className="text-[var(--text-dim)] mt-8 mb-8 text-sm md:text-base">
            Explora mis trabajos. Filtra por stack o busca por nombre.
          </p>
        </Reveal>
          ...
          <div className="surface p-4 mb-10">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <input
                ...
                className="flex-1 rounded-lg bg-[var(--bg-elev-2)] border border-[var(--line)] px-3 py-2 outline-none focus:ring-2 focus:ring-[var(--ring)] text-sm"
