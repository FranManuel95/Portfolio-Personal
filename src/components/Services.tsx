...
const services = [
  {
    ...
    shadowHover: "hover:shadow-[0_0_60px_-14px_rgba(96,165,250,0.5)]",
    items: [
  ...
  },
  {
    ...
    shadowHover: "hover:shadow-[0_0_60px_-14px_rgba(167,139,250,0.5)]",
    items: [
  ...
  },
  {
    ...
    shadowHover: "hover:shadow-[0_0_60px_-14px_rgba(251,146,60,0.5)]",
    items: [
  ...
  },
  {
    ...
    shadowHover: "hover:shadow-[0_0_60px_-14px_rgba(52,211,153,0.5)]",
    items: [
          ...
          {services.map((s, i) => {
            ...
            return (
              <Reveal replay key={s.title} delayMs={80 + i * 60}>
                <div
                  className={[
                    "glow-card group relative h-full p-6",
