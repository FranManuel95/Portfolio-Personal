...
const services = [
  {
    ...
    accent: "#a78bfa",
    items: [
      "Sistemas RAG con recuperación semántica (Pinecone) sobre documentación especializada",
      "Agentes conversacionales con memoria, herramientas y MCP Servers propios",
      "Orquestación multi-modelo con routing inteligente (Claude, OpenAI, Gemini)",
      "Optimización de costes de LLMs según tipo de operación",
    ],
  },
  {
    num: "02",
    ...
    accent: "#fb923c",
    items: [
      "Flujos end-to-end con n8n y Airtable que sustituyen procesos manuales",
      "Agentes comerciales y de comunicación interna por WhatsApp (UltraMsg / Baileys)",
      "Integración entre plataformas educativas, CRMs y almacenamiento en la nube",
      "Pipelines de validación, documentos y notificaciones entre equipos",
    ],
  },
  {
    num: "03",
    ...
    accent: "#60a5fa",
    items: [
      "Aplicaciones full-stack con Next.js, React y TypeScript en producción",
      "Backend con Node.js, Express, PHP/Symfony y Django",
      "Bases de datos relacionales y en la nube: Supabase, MySQL, PostgreSQL",
      "Deploy con Docker, Vercel, Netlify, Cloudflare y VPS Linux",
    ],
  },
  {
    num: "04",
    ...
    accent: "#34d399",
    items: [
      "Diseño y despliegue de MCP Servers propios para casos de uso específicos",
      "Integración de Claude y otros LLMs con herramientas y datos internos",
      "Skills personalizados para flujos de trabajo corporativos",
      "Arquitectura de sistemas de IA mantenibles y sin deuda técnica",
    ],
  },
];
