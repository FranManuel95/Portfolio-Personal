            ...
            <Reveal replay key={`${exp.company}-${i}`}>
              <article
                className={[
                  ...
                  exp.highlight
                    ? "border-[var(--accent)]/40 shadow-[0_0_0_1px_rgba(129,140,248,0.25),0_0_48px_-10px_rgba(129,140,248,0.5)]"
                    : "hover:shadow-[0_0_0_1px_rgba(129,140,248,0.15),0_0_32px_-12px_rgba(129,140,248,0.25)]",
                ].join(" ")}
              >
                <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
                  <div>
                    ...
                    <p className="mt-0.5 font-medium text-[var(--accent)]">
                      ...
                      {exp.highlight && (
                        <span
                          className="ml-2 text-xs px-2 py-0.5 rounded-full bg-[var(--accent)]/15 text-[var(--accent)] border border-[var(--accent)]/30"
                          style={{ boxShadow: "0 0 12px -4px rgba(129,140,248,0.5)" }}
                        >
                          Actual
                        </span>
                      )}
