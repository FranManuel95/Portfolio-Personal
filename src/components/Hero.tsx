...
const Hero = ({ isMenuOpen }: { isMenuOpen: boolean }) => {
  return (
    <section
      className={`bg-gradient-to-r from-gray-900 to-black text-white flex flex-col lg:flex-row justify-center items-center text-center lg:text-left px-8 pt-16 mt-2 transition-all duration-300 ease-in-out gap-2 ${
