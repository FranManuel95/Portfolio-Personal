...
const Hero = ({ isMenuOpen }: { isMenuOpen: boolean }) => {
  // Parallax solo en desktop; en móvil dejamos estático
  ...
  return (
    <section
      ...
      // mueve el glow solo en desktop (evita trabajo en móvil)
      onPointerMove={(e) => {
    ...
    >
      {/* BACKGROUNDS */}
      {/* Fondo LIGERO para móvil (sin mask/blur), y pesado para md+ */}
      <div
        aria-hidden
        className="
          absolute inset-0 z-0
          bg-[radial-gradient(65%_60%_at_50%_0%,rgba(124,134,255,0.16),transparent)]
          md:bg-[radial-gradient(70%_60%_at_20%_0%,rgba(124,134,255,0.25),transparent),radial-gradient(50%_40%_at_90%_80%,rgba(255,255,255,0.08),transparent)]
        "
        style={{ contain: "paint" }}
      />

      {/* Grid + mask SOLO en desktop (iOS sufre con mask-image en first paint) */}
      <div
        aria-hidden
      ...
      {/* Glow con blur grande SOLO en desktop */}
      <motion.div
        aria-hidden
